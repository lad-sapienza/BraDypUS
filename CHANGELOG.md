...
### Fixed
- Fixed bug with QueryFromRequest->makeSafeStatement() being too aggressive on strings

## [4.5.0] - 2025-12-13

### Added
- Added Dockerfile and support for Docker image building and publishing on Docker hub on each release
